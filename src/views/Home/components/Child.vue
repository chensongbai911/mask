<template>
  <div
    ref="childNodeRef" class="children-wrap" :style="{
  ...
  >
    <div
      v-for="item in data" :key="item.goodsImage" class="child-wrap mover"
    >
      <el-image style="width: 100%; height: 100%" :src="item.goodsImage" fit="cover" />
    </div>
  </div>
</template>
